...
// Styling
import "./checkoutform.component.style.scss";
  ...
  return (
    <form id="payment-form" onSubmit={handleSubmit}>
      ...
      <button disabled={isLoading || !stripe || !elements} id="submit" className="pay-btn">
        <span id="button-text">
          {siteLanguage == "TR" ? "Hemen öde" : "Pay Now"}
        </span>
      </button>
      {/* Show any error or success messages */}
      {message && <div className={`${darkMode ? "font-dark" : "font-light"}`} id="payment-message">{message}</div>}
    </form>
  );
}